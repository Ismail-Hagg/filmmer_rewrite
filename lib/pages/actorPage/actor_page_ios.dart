...
class ActorPageIos extends StatelessWidget {
  const ActorPageIos({super.key});
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: controller.flip == 0
                                        ? controller.detales.movieResults ==
                                            ...
                                            ? 0
                                            : controller
                                                .detales.movieResults!.length
                                        : controller.detales.tvResults == null
                                            ? 0
                                            : controller
                                                .detales.tvResults!.length,
                                    itemBuilder: (context, index) {
                                      return Padding(
